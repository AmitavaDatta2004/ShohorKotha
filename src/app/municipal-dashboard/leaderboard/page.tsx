...
import { Trophy, Star, Shield, Medal, User, Briefcase, Zap, Activity, TrendingUp } from "lucide-react";
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="border-slate-50 hover:bg-transparent">
                                        ...
                                        <TableHead className="text-right text-[10px] font-black uppercase tracking-widest text-slate-400">Score</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
