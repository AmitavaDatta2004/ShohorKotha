...
import { Trophy, Medal, User, Briefcase, Zap, TrendingUp, Activity, Shield } from "lucide-react";
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-slate-200 pb-8">
                <div>
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Community Rankings</span>
                    </div>
                    <h1 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter">Impact Elite.</h1>
                    <p className="text-slate-500 font-medium text-base mt-2 italic max-w-xl">Celebrating top contributors and staff performance across the city grid.</p>
                </div>
                <div className="hidden lg:flex bg-white p-4 rounded-3xl border border-slate-100 shadow-sm items-center gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 leading-none mb-1">Global Load</p>
                            <p className="text-sm font-black text-slate-900 leading-none">High Impact</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 leading-none mb-1">Growth Index</p>
                            <p className="text-sm font-black text-slate-900 leading-none">+12.4% MoM</p>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <Card className="rounded-[2.5rem] border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden bg-white">
                    <CardHeader className="p-8 pb-4">
                        <div className="flex items-center gap-4 mb-2">
                            ...
                            <div>
                                <CardTitle className="text-xl font-black text-slate-900 tracking-tight">Top Citizens</CardTitle>
                                <CardDescription className="font-medium text-slate-500 text-xs">Ranked by utility points earned from high-severity reporting.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-slate-50 hover:bg-transparent">
                                    ...
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest text-slate-400">Contributor</TableHead>
                    ...
                    <CardHeader className="p-8 pb-4">
                        <div className="flex items-center gap-4 mb-2">
                            ...
                            <div>
                                ...
                                <CardDescription className="font-medium text-slate-500 text-xs">Supervisors ranked by cumulative efficiency and trust metrics.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="px-8 pb-8">
